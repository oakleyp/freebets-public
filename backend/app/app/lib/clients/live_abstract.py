...
from app.lib.schemas.live_racing import RacePoolTotals, RaceWithStarterDetails, StarterDetails, TrackWithRaceDetails
...
class AbstractLiveRacingClient(ABC):
    ...
    def get_race_entries(
        ...
        raise NotImplementedError(
            "get_race_entries() not implemented for %s" % self.__class__.__name__
        )
    ...
    def get_races_today(self) -> List[TrackWithRaceDetails]:
        ...
        raise NotImplementedError(
            "get_races_today() not implemented for %s" % self.__class__.__name__
        )
    ...
    def get_races_by_date(self, tdate: date) -> List[TrackWithRaceDetails]:
        ...
        raise NotImplementedError(
            "get_races_by_date() not implemented for %s" % self.__class__.__name__
        )
