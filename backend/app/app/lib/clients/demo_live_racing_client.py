...
from app.tests.utils.race_data import create_starters_n, create_track_with_race_details_n
...
class DemoLiveRacingClient(AbstractLiveRacingClient):
    ...
    def get_race_entries(self, track_code: str, race_no: int, type: str = "Thoroughbred") -> List[StarterDetails]:
