...
def get_expected_place_val_per_dollar(race: Race, selection: RaceEntry, track_payback: float = Q) -> float:
...
def get_expected_show_val_per_dollar(race, selection: RaceEntry, track_payback: float = Q) -> float:
    W_i = selection.win_pool_total
    W = race.win_pool_total
